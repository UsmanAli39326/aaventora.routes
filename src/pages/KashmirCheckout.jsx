            ...
            <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div className="bg-white p-6 rounded-2xl shadow mb-8">
                        ...
                        <p className="text-gray-600">
                            Kashmir Valley – 5 Days Scenic & Cultural Experience
                        </p>
                    </div>
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg h-fit">
                    ...
                    <div className="space-y-4 text-gray-600 mb-6">
                        <p><strong>Trip:</strong> Kashmir Valley</p>
                    ...
                    <a
                        href="https://wa.me/923001234567?text=Hello%20I%20would%20like%20to%20inquire%20about%20the%20Kashmir%20trip."
                        target="_blank"
...
export default KashmirCheckout;
